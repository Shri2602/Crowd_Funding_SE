...
<html>
<head>
	<title>Image Display with CSS and Two Buttons</title>
	<style>
		.image-container {
			position: relative;
...
<br>
<body>
<h2>Fill The Form For Donation Confirmation !! 
...
?>	
  ...
  <button  class="button" onclick="alert('Thank You For Your Contribution! Your Screenshot will be verified by admin & certificate will be sent to your email')" style="font-size: 24px; background-color: #4CAF50; color: white; padding: 16px 32px; border: none; border-radius: 4px;" required>Get Certificate</button>
</form>
</div>
</div>
