  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">crowdfunding@gmail.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+91-9373271341</span></i>
      </div>
  ...
  <main id="main">
    ...
    <!-- <section id="pricing" class="pricing">
     ...
     <section class="fundraiser-section">
            <h2>Help Make a Difference with Fundraisers</h2>
            <p>Fundraisers are a great way to make a positive impact in our communities. Whether it's for a local charity, school, or personal cause, everyone can play a role in helping to raise money for a good cause. </p>
            <p>By participating in a fundraiser, you not only support a worthy cause, but you also bring awareness to the issue at hand. Whether it's through donation or spreading the word, every little bit helps. </p>
            <a href="about2.html">Learn More About Fundraisers</a>
        </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">Fundraisers are a great way to make a positive impact in our communities. Whether it's for a local charity, school, or personal cause, everyone can play a role in helping to raise money for a good cause..</p>
          </div>
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              <li style="display: inline-block;"><a href="about2.html">About Us</a></li>
              <li><a href="contact2.html">Contact Us</a></li>
              <li><a href="campaign-list.php">Contribute</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-sm-6 col-xs-12">
            <p class="copyright-text">Made BY Shrikant & Hariom.
